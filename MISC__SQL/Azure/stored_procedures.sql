...
BEGIN
	...
	ELSE
		BEGIN
			INSERT INTO [SQL-MOVE].[dbo].NETWORKS (networkID) VALUES (@networkID)
		END
END
GO
...
BEGIN
	...
	(
		...
		FROM [SQL-MOVE].[dbo].APPLICATIONS
	...
	ELSE
		BEGIN
			INSERT INTO [SQL-MOVE].[dbo].APPLICATIONS (applicationID) VALUES (@applicationID)
		END
END
GO
...
BEGIN
	...
	ELSE
		BEGIN
			SET @sensorID = NULL
			SET @sensorID = NEWID()
			INSERT INTO [SQL-MOVE].[dbo].SENSORS (sensorID, applicationID, networkID, sensorName) VALUES (@sensorID, @applicationID, @networkID, @sensorName)
		END
END
GO
...
BEGIN
	...
	ELSE
		BEGIN
			...
			INSERT INTO [SQL-MOVE].[dbo].DATA_TYPES (dataTypeID, dataType) VALUES (@dataTypeID, @dataType)
		END
END
GO
...
BEGIN
	...
	ELSE
		BEGIN
			...
			INSERT INTO [SQL-MOVE].[dbo].PLOT_LABELS (plotLabelID, plotLabel) VALUES (@plotLabelID, @plotLabel)
		END
END
GO
...
BEGIN
	...
	INSERT INTO [SQL-MOVE].[dbo].READINGS (readingID, dataMessageGUID, sensorID, rawData, dataTypeID, dataValue, plotLabelID, plotValue, messageDate) VALUES (@readingID, @dataMessageGUID, @sensorID, @rawData, @dataTypeID, @dataValue, @plotLabelID, @plotValue, @messageDate)
END
GO
...
BEGIN
	SET NOCOUNT ON;
	INSERT INTO [SQL-MOVE].[dbo].SIGNAL_STATUS (readingID, dataMessageGUID, signalStrength) VALUES (@readingID, @dataMessageGUID, @signalStrength)
END
GO
...
BEGIN
	SET NOCOUNT ON;
	INSERT INTO [SQL-MOVE].[dbo].BATTERY_STATUS (readingID, dataMessageGUID, batteryLevel) VALUES (@readingID, @dataMessageGUID, @batteryLevel)
END
GO
...
BEGIN
	SET NOCOUNT ON;
	INSERT INTO [SQL-MOVE].[dbo].PENDING_CHANGES (readingID, dataMessageGUID, pendingChange) VALUES (@readingID, @dataMessageGUID, @pendingChange)
END
GO
...
BEGIN
	SET NOCOUNT ON;
	INSERT INTO [SQL-MOVE].[dbo].SENSOR_VOLTAGE (readingID, dataMessageGUID, voltage) VALUES (@readingID, @dataMessageGUID, @voltage)
END
GO