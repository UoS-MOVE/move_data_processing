...
#params = splitDf['networkID'].values.tolist()
params = splitDf[['networkID']]
params = list(params.itertuples(index=False))
...
sql = """\
	...
	"""
# Bind the parameters that are required for the procedure to function
params = splitDf[['applicationID', 'networkID', 'sensorName']]
params = list(params.itertuples(index=False))
...
sql = """\
	...
	"""
# Bind the parameters that are required for the procedure to function
params = splitDf[['dataMessageGUID', 'sensorID', 'rawData', 'dataTypeID', 'dataValue', 'plotLabelID', 'plotValues', 'messageDate']]
params = list(params.itertuples(index=False))
...
# Bind the parameters that are required for the procedure to function
params = splitDf[['readingID', 'dataMessageGUID', 'signalStrength']]
params = list(params.itertuples(index=False))
...
# Bind the parameters that are required for the procedure to function
params = splitDf[['readingID', 'dataMessageGUID', 'batteryLevel']]
params = list(params.itertuples(index=False))
...
# Bind the parameters that are required for the procedure to function
params = splitDf[['readingID', 'dataMessageGUID', 'pendingChange']]
params = list(params.itertuples(index=False))
...
# Bind the parameters that are required for the procedure to function
params = splitDf[['readingID', 'dataMessageGUID', 'voltage']]
params = list(params.itertuples(index=False))
