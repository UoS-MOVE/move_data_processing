...
CREATE TABLE salfordMove.dbo.SIGNAL_STATUS(
	...
	CONSTRAINT PK_SIGNAL_STATUS PRIMARY KEY (sensorID, dataMessageGUID),
	CONSTRAINT FK_SIGNAL_STATUS_GUID FOREIGN KEY (dataMessageGUID)
	REFERENCES salfordMove.dbo.READINGS (dataMessageGUID)
	ON DELETE CASCADE
	ON UPDATE CASCADE
);
...
CREATE TABLE salfordMove.dbo.BATTERY_STATUS(
	...
	dataMessageGUID UNIQUEIDENTIFIER NOT NULL,
	batteryLevel INT,
	CONSTRAINT PK_BATTERY_STATUS PRIMARY KEY (sensorID, dataMessageGUID),
